...
local function fn(Sim)
    ...
    minimap:SetIcon("bloodbook_plus.tex")
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/bloodbook_plus.xml" 
...
return Prefab("common/inventory/bloodbook_plus", fn, assets) 
